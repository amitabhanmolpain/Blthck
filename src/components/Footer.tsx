        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-4 gsap-slide-right">
            ...
            <div className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-xl p-4">
              ...
              <p className="text-gray-400 text-sm mb-3">Get weekly ghost job insights</p>
              ...
              {!isSubscribed ? (
                <form onSubmit={handleSubscribe} className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 bg-black/20 backdrop-blur-xl border border-white/20 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                  >
                    {isSubmitting ? (
